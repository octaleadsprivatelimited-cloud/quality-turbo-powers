...
const Services = () => {
  ...
  const industries = [
    { name: "Power Generation", icon: Zap, color: "from-blue-500 to-blue-600" },
    { name: "Petrochemicals", icon: Factory, color: "from-blue-500 to-blue-600" },
    { name: "Steel Plants", icon: Building2, color: "from-blue-500 to-blue-600" },
    { name: "Cement Industry", icon: Box, color: "from-blue-500 to-blue-600" },
    { name: "Fertilizers", icon: Wheat, color: "from-blue-500 to-blue-600" },
    { name: "Paper Manufacturing", icon: Box, color: "from-blue-500 to-blue-600" },
    { name: "Oil & Gas", icon: Flame, color: "from-blue-500 to-blue-600" },
    { name: "Sugar Mills", icon: Cog, color: "from-blue-600 to-blue-700" }
  ];
  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
          ...
          >
            <div className="text-center mb-14">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900">
                Services <span className="text-blue-500">Offered</span>
              </h2>
            </div>
                    ...
                    <div className="relative h-52 overflow-hidden">
                      ...
                      <div className="absolute bottom-4 left-4 right-4">
                        <Link to={service.link}>
                          <h3 className="text-xl font-bold text-white hover:text-blue-300 transition-colors cursor-pointer">{service.title}</h3>
                        </Link>
                      </div>
                    </div>
      ...
      <section className="relative py-16 overflow-hidden">
        ...
        <div className="absolute bottom-0 right-1/4 w-56 h-56 bg-blue-500/10 rounded-full blur-3xl" />
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20 relative z-10">
          ...
          >
            ...
            <div className="text-center mb-10">
              <div 
                className={`inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/10 text-blue-400 text-xs font-semibold px-4 py-1.5 rounded-full mb-3 transition-all duration-700 delay-100 ${
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-white">
                Industries We{" "}
                <span className="bg-gradient-to-r from-blue-400 to-blue-500 bg-clip-text text-transparent">Serve</span>
              </h2>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {industries.map((industry, index) => {
                ...
                return (
                  <div 
                    key={index}
                    className={`group relative bg-white/5 backdrop-blur-sm rounded-xl p-5 border border-white/10 hover:border-blue-500/50 hover:bg-white/10 transition-all duration-500 cursor-default ${
                      industriesVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                    }`}
                    style={{ transitionDelay: `${200 + index * 70}ms` }}
                  >
                    {/* Hover glow */}
                    <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-blue-500/0 to-blue-600/0 group-hover:from-blue-500/10 group-hover:to-blue-600/5 transition-all duration-500" />
                    ...
                    {/* Bottom accent line */}
                    <div className="absolute bottom-0 left-4 right-4 h-0.5 bg-gradient-to-r from-blue-500 to-blue-600 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 rounded-full" />
                  </div>
                );
              })}
            </div>

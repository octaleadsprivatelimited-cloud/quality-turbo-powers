...
const Index = () => {
  return (
    <div className="min-h-screen font-sans">
      <Helmet>
        <title>Quality Turbo Power Services | Industrial Turbine Services in Hyderabad | Rotating Equipment Solutions</title>
        <meta name="description" content="Quality Turbo Power Services - Leading provider of complete rotating equipment solutions in Hyderabad. Expert turbine erection, commissioning, overhauls, repairs, and maintenance services for power plants, petrochemicals, steel, cement, and oil & gas industries. Trusted since 2018." />
        ...
        <meta property="og:title" content="Quality Turbo Power Services | Industrial Turbine Services in Hyderabad" />

        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          {stats.map((stat, index) => {
            ...
            return (
              <div 
                key={index} 
                className="group relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:bg-white/10 hover:border-[#9ee055]/30 transition-all duration-300"
              >
                {/* Icon */}
                ...
                <div className="mb-2">
                  ...
                  <span className="text-3xl md:text-4xl font-bold text-[#9ee055]">{stat.suffix}</span>
                </div>
                ...
                {/* Hover accent */}
                <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-[#283852] to-[#9ee055] rounded-b-2xl transform scale-x-0 group-hover:scale-x-100 transition-transform origin-left" />
              </div>
            );
          })}
        </div>

  ...
  return (
    <section ref={sectionRef} className="py-20 bg-slate-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-[#72c530]/10 rounded-full blur-[120px]" />
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-[#72c530]/10 rounded-full blur-[120px]" />
      </div>
      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-20 relative">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-1.5 mb-4">
            <span className="w-2 h-2 bg-[#72c530] rounded-full animate-pulse" />
            <span className="text-white/80 text-xs uppercase tracking-wider">Our Impact</span>
          </div>
          <h2 className="text-3xl md:text-4xl font-bold text-white">
            Delivering <span className="text-[#72c530]">Excellence</span> Since 2018
          </h2>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          {stats.map((stat, index) => {
            ...
            return (
              <div 
                key={index} 
                className="group relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:bg-white/10 hover:border-[#72c530]/30 transition-all duration-300"
              >
                {/* Icon */}
                ...
                <div className="mb-2">
                  ...
                  <span className="text-3xl md:text-4xl font-bold text-[#72c530]">{stat.suffix}</span>
                </div>
                ...
                {/* Hover accent */}
                <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-[#283852] to-[#72c530] rounded-b-2xl transform scale-x-0 group-hover:scale-x-100 transition-transform origin-left" />
              </div>
            );
          })}
        </div>
